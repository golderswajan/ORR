...
*/
include_once($_SERVER['DOCUMENT_ROOT'].'/se/dashboard/dal/dal.syllabus.php');
		...
		while ($res = mysqli_fetch_assoc($result))
		 {
          ...
          $termInfo = $bllCourseOffer->offeredTermInfoById($res["offeredTermId"]);
