<?php
include_once("bll/bll.courseoffer.php");
      ...
      <form class="form-group" id="terms" method="POST">
        ...
        <option value="null"> Select a term </option>
         <?php
          ...
          $result = $bllCourseOffer->offeredTermInfo($varsityDeptId);
          echo $result;
         ?>
      ...
      <form class="form-group" method="POST">
        <label for="courses">Select Courses for
         ...
         <?php
          if(isset($_SESSION['term_select_submited']))
          {
            $result = $bllCourseOffer->getCourseByOfferedTerm($_SESSION['term_select_submited']);
           echo $result;
